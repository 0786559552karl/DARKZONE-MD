...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME || getConfig("BOT_NAME") || "KARL AI ASSISTANCE",  // Bot's display name
    ...
    DESCRIPTION: process.env.DESCRIPTION || "*© CREATER MARX MURONZI*",  // Bot description
